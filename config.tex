...
\usepackage[
	hidelinks, % keine roten Markierungen bei Links
	bookmarks=false % Workaround fuer xdvipdfmx-Absturz unter XeLaTeX/TeX Live 2025
]{hyperref}
...
\usepackage{fourier-otf}   % Fourier/Utopia for rm text with Unicode engines
...
\KOMAoptions{footheight=18.85002pt}
...
\ifoot[\rule{0pt}{\ht\strutbox+\dp\strutbox}TH Mannheim]{\rule{0pt}{\ht\strutbox+\dp\strutbox}HS Mannheim}
